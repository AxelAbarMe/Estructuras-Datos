...
Repositorio de teoría, labs, prácticas, proyectos, quices y tareas del curso de Estructuras de Datos.

---

## 💻 Códigos de Clase
> Copia directa del repositorio de código usado durante las clases.

- [CodigosClase](https://github.com/AxelAbarMe/Estructuras-Datos/tree/main/General/CodigosClase) — Extraído de [josecalvosuarez/estructuras-de-datos](https://github.com/josecalvosuarez/estructuras-de-datos).

---

## 📚 Teoría
> Apuntes de clase y avances semanales.

- [Clase 1-2 { Apuntes }](https://github.com/AxelAbarMe/Estructuras-Datos/blob/main/General/Teoria/Clase_1-2_Apuntes.md) - Arquitectura, Memory Segment, Monolítico vs Microservicios, Compiler vs Interpreter
- [Clase 3 { Apuntes }](https://github.com/AxelAbarMe/Estructuras-Datos/blob/main/General/Teoria/Clase_3_Apuntes.md) - Compiler vs Interpreter, Git, Debugger
- [Clase 4 { Apuntes }](https://github.com/AxelAbarMe/Estructuras-Datos/blob/main/General/Teoria/Clase_4_Apuntes.md) - Archivos (.txt | .bin | .json | .xml | .yaml)
...
- [Clase 10 { Apuntes }](ttps://github.com/AxelAbarMe/Estructuras-Datos/blob/main/General/Teoria/Clase_%6010_Apuntes.md) - Pendiente
...
- [Proyecto 1](https://github.com/AxelAbarMe/Estructuras-Datos/tree/main/General/Proyectos/Proyecto%201)
- [Proyecto 2](https://github.com/AxelAbarMe/Estructuras-Datos/tree/main/General/Proyectos/Proyecto%202)
...
📌 *La carpeta `CodigosClase` es una copia del repositorio de [josecalvosuarez/estructuras-de-datos](https://github.com/josecalvosuarez/estructuras-de-datos).*
